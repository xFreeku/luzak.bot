...
subtitle: function(data) {
	return `Kliknij "Edit" po wiecej informacji!`;
},
...
short_description: "Paczka modow uzywana i stworzona przez KRINDEX#9509",
...
html: function(isEvent, data) {
	return `
	<h1 style="color: #fff">Hej!</h1>
Dziekuje za skorzystanie z mojej paczki modow!<br>
Jezeli chcesz cos mi przekazac napisz do mnie na discordzie lub w komenatrzu na YouTube. Milego korzystania!<br><br>
	<h1 style="color: #fff">Autor</h1>
Autorem paczki modow jest KRINDEX<br>
Kanal YouTube: youtube.com/c/krindex<br><br>
	<h1 style="color: #fff">Paczka</h1>
Nie jestem autorem modow znajdujacych sie w paczce. Nie biore odpowiedzialnosci za bledy w dzialaniu i inne problemy. Wszystkie mody znajdujace sie w paczce naleza do ich tworcow lub osob uprawionych. Wersja: 1.0.0<br><br>
	`
},
